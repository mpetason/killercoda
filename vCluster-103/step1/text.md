...
We'll create two vClusters: `my-vcluster-a` and `my-vcluster-b` (both in namespace `team-x`). Then we'll deploy the same application and service name `my-app` in both and expose them.
